...
-module(decimal_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("./decimal_lexer.xrl", 14).
...
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 42 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 58, C =< 68 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 70, C =< 100 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 102 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
-file("./decimal_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { sign, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("./decimal_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { digits, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("./decimal_lexer.xrl", 9).
yyaction_2(TokenChars, TokenLine) ->
     { token, { indicator, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("./decimal_lexer.xrl", 10).
yyaction_3(TokenChars, TokenLine) ->
